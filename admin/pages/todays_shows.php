      ...
      <div class="box-body">
        <?php
          ...
          while ($len != 0){
            ...
            $sw=mysqli_query($con,"select * from tbl_shows where st_id in(select st_id from tbl_show_time where screen_id in(select screen_id from  tbl_screens where t_id='".$array[$counter]."')) and status='1' and r_status='1'");
            $counter += 1;
            $len -= 1;
