								...
								?>
									...
									<tr>
										...
										<td>
											...
											<input type="number" required tile="Number of Seats" max="<?php echo $screen['seats'];?>" min="0" name="seats" class="form-control" value="1" style="text-align:center" id="seats"/>
